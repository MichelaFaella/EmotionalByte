...
label_map = {'hap': 0, 'sad': 1, 'ang': 2, 'neu': 3, 'fru':4, 'exc':5, 'sur':6, 'fea':7, 'dis':8,'xxx':9, 'oth':10}
...
# Salvataggio finale
with open("src/iemocap_multimodal_features.pkl", "wb") as f:
    pickle.dump(
